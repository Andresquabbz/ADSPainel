...
BEGIN
  ...
  VALUES (NEW.id,'bonus',50,50,'Bônus de boas-vindas');
  RETURN NEW;
END; $$;
...
('free','Free',0,1,50,false,false,'["1 site ativo","50 tokens","Subdomínio SITEAI"]',1),
...
('starter','Starter',100,990,1),
('pro','Pro',500,3990,2),
('business','Business',1500,8990,3),
('agency','Agency',5000,19990,4);
