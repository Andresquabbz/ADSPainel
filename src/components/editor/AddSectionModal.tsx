...
const TEMPLATE_OPTIONS: SectionTemplateOption[] = [
  ...
  },
  {
    type: "mission",
    title: "Nossa Missão",
    description: "Seção de destaque visual com missão, visão e pilares institucionais da empresa.",
    icon: ShieldCheck,
    defaultData: () => ({
      type: "mission",
      title: "Nossa Missão",
      description: "Prestar serviços com ética, integridade e excelência, proporcionando segurança e valor real para clientes e parceiros.",
      pillars: [
        { title: "Segurança Jurídica", description: "Conformidade e rigor técnico em todas as operações." },
        { title: "Transparência Total", description: "Comunicação clara e relacionamento de mútua confiança." },
        { title: "Excelência Operacional", description: "Agilidade e precisão do primeiro contato até a conclusão." },
      ],
    }),
  },
  {
    type: "company_services",
    title: "Serviços Dinâmicos",
    description: "Grade profissional com lista de serviços, ícones corporativos e links.",
    icon: Briefcase,
    defaultData: () => ({
      type: "company_services",
      title: "Nossos Serviços",
      subtitle: "Soluções planejadas para atender às necessidades específicas da sua empresa.",
      items: [
        { id: "srv-1", name: "Preparação de Documentos", description: "Elaboração, revisão técnica e gestão de contratos corporativos.", icon: "FileText", category: "Documental", link: "#contato", status: "active" },
        { id: "srv-2", name: "Apoio Administrativo", description: "Suporte operacional e consultoria para otimização de fluxos.", icon: "Briefcase", category: "Gestão", link: "#contato", status: "active" },
        { id: "srv-3", name: "Informações Cadastrais", description: "Diagnóstico e regularização de registros corporativos.", icon: "Building", category: "Cadastral", link: "#contato", status: "active" },
        { id: "srv-4", name: "Consultoria Estratégica", description: "Planejamento estruturado para expansão e governança.", icon: "TrendingUp", category: "Estratégia", link: "#contato", status: "active" },
      ],
    }),
  },
  {
    type: "company_info",
    title: "Informações da Empresa (Ficha Cadastral)",
    description: "Ficha cadastral transparente exibindo Razão Social, CNPJ, data de abertura, porte e capital social.",
    icon: Building2,
    defaultData: (name) => ({
      type: "company_info",
      title: "Informações da Empresa",
      subtitle: "Ficha cadastral e dados institucionais para sua total segurança e transparência.",
      legal_name: `${name} Consultoria e Serviços Ltda.`,
      fantasy_name: name,
  ...
  {
    type: "location",
    title: "Onde Estamos (Localização com Mapa)",
    description: "Endereço completo da empresa e mapa interativo ativável.",
    icon: MapPin,
    defaultData: () => ({
      type: "location",
      title: "Onde Estamos",
